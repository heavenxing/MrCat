...
#   sh $MRCATDIR/general/clean_logdir.sh $logDir
# or automated on the que as:
#   fsl_sub -N cleanup -j runscript -q veryshort.q -l $logDir sh $MRCATDIR/general/clean_logdir.sh $logDir
...
#   jobID=$(sh $MRCATDIR/general/jobID.sh $jobID)
