...
rsn_func2dconn.sh: Register func to F99 and create dtseries. Assuming standardized data organization

example:
      sh rsn_func2dtseries.sh /Users/rogiermars/data/rsc/peewee filtered_brain
